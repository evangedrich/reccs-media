		...
		<div>
			...
			<div className="min-h-40 p-4 border-b-2 border-solid border-[var(--color-front)]">
				<div className="max-w-[1000px] m-auto">
					<p className="mb-2">{preParse("Reccs collects a variety of literary, cinematic, and theatrical works from each of the United Nations geoscheme subregions (modified slightly to better conform the subregions, devised for statistical purposes, to their corresponding culturally-affiliated regions). Click around the geoscheme to explore works by region, or navigate above for the complete collections.")}</p>

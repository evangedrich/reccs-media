...
export const regions: RegionType[] = [
    ...
    { id: "all", color: "r", code: ["AF","AM","AS","EU","OC"] }
];

export const subregions: SubregionType[] = [
    { id: "AFNO", name: "North Africa", neighbors: ["EUWE","ASWE","AFNC"], description: "The Amazigh languages themselves——in addition to their persistence, with Coptic, as substrata on regional Arabic dialects——anchor the distinctive linguistic and cultural heritage of the Maghreb and outer Sahara." },
    ...
    { id: "AFWE", name: "West Africa", neighbors: ["AFNC","AFCE"], description: "Comprised of Upper and Lower Guinea (separated by the Dahomey Gap) and the western Sudanian savanna, this subregion is dominated by the western branches of the Niger–Congo language family." },
    { id: "AFNC", name: "North-Central Africa", neighbors: ["AFNO","AFWE"], description: "From the Tibesti Mountains in the north to the Lake Chad Basin in the south, the Chadic and Saharan languages extend across the oases found in the central Sahara and Sahel." },
    ...
    { id: "ASSO", name: "South Asia", neighbors: ["ASHI","ASSW"], description: "The Dravidian languages dominate the southern Deccan peninsula, whereas Indo-Aryan languages extend across the northern Ganga and Indus plains, the Thar desert, and the northeastern mountain zone." },
    { id: "ASSW", name: "Southwest Asia", neighbors: ["ASWE","ASSO","ASCE"], description: "Resting south of the Caspian Sea, the Iranian Plateau runs from the Zagros Mountains in the west to the Sulaiman Mountains in the east, populated by speakers of Iranic languages and their neighbors in the southeast Caucasus." },
    { id: "ASWE", name: "West Asia", neighbors: ["AFNO","ASSW","EUEA"], description: "The Arabian Peninsula, Mesopotamia, and the Levant are populated by speakers of the predominant Semitic languages in this subregion." },

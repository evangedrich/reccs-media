...
export const subregions: SubregionType[] = [
    { id: "AFNO", name: "North Africa", neighbors: ["EUWE","ASWE","AFWE"], description: "The Amazigh languages anchor the distinctive linguistic and cultural heritage of the Maghreb and outer Sahara." },
    ...
    { id: "AFNC", name: "North-Central Africa", neighbors: ["AFNO","AFWE"], description: "The Chadic and Saharan languages spread across the semi-arid central Sahel and hyper-arid inner Sahara." },
    ...
    { id: "ASSW", name: "Southwest Asia", neighbors: ["ASWE","ASSO","ASCE"], description: "The Iranian Plateau" },
    { id: "ASWE", name: "West Asia", neighbors: ["AFNO","ASSW","EUEA"], description: "The Arabian Peninsula and Anatolia comprise the Arabic, Persic, and Turkic spheres of this subregion, in addition to transitional areas like Mesopotamia, Sinai, and the Armenian Highlands." },

...
export const subregions: SubregionType[] = [
    ...
    { id: "EUEA", name: "Eastern Europe", neighbors: ["EUWE","ASNO","ASWE","ASCE"], description: "This subregion is dominated by the Balto-Slavic and Uralic language families and the Balkan sprachbund; its extensive plains are bordered by the Carpathian, Ural, and Caucasus mountain ranges to the west, east, and south." },

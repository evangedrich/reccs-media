...
export default function PrivacyPolicyPage() {
    return (
        <div className="max-w-[1000px] mx-auto py-4 pb-10 flex flex-col gap-2 px-4">
            ...
            <h2 className="text-xl font-bold mt-4">Does the Application collect precise real time location information of the device?</h2>
            <p>This Application does not gather precise information about the location of your mobile device.</p>

            <h2 className="text-xl font-bold mt-4">Do third parties see and/or have access to information obtained by the Application?</h2>
            <p>Since the Application does not collect any information, no data is shared with third parties.</p>

            <h2 className="text-xl font-bold mt-4">Does the Application use Artificial Intelligence (AI) technologies?</h2>
            <p>The Application does not use Artificial Intelligence (AI) technologies to process your data or provide features.</p>

            <h2 className="text-xl font-bold mt-4">What are my opt-out rights?</h2>
            ...
            <h2 className="text-xl font-bold mt-4">How will you be informed of changes to this Privacy Policy?</h2>
            <p>This Privacy Policy may be updated from time to time for any reason. The Service Provider will notify you of any changes to the Privacy Policy by updating this page with the new Privacy Policy. You are advised to consult this Privacy Policy regularly for any changes, as continued use is deemed approval of all changes.</p>
            <p>This privacy policy is effective as of 2026-05-06</p>

            <h2 className="text-xl font-bold mt-4">How do you give your consent?</h2>
            ...
            <h2 className="text-xl font-bold mt-4">How can you contact us?</h2>
            <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at admin@evangedrich.com.</p>
        </div>
    )
}

...
import { juliaMonoSubset, notoMalayalam, miSansTibetan, notoCanadian, notoArabic, notoTamil, notoTelugu, notoEthiopic, notoDevanagari, ingeoTifinagh, notoBamum, notoThai, notoKhmer, notoBalinese, notoKorean } from "./fonts/fonts";
import "./globals.css";
...
const scriptFontVars = [notoMalayalam, miSansTibetan, notoCanadian, notoArabic, notoTamil, notoTelugu, notoEthiopic, notoDevanagari, ingeoTifinagh, notoBamum, notoThai, notoKhmer, notoBalinese, notoKorean]
  .map((f) => f.variable)
  .join(" ");

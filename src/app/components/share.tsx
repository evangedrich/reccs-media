...
const shareIcons: React.ReactElement[] = [
    <svg viewBox="-15 -15 130 130" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",height:"100%"}} key="share1">
    ...
    <svg viewBox="-20 -20 140 140" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",height:"100%"}} className="group-hover:opacity-80 group-active:scale-90 transition-transform" key="share2">
